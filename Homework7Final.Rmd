...
# Calculate proportions and difference for GOTV and no GOTV voters
...
# Difference in proportions and Confidence Interval
p1 <- prop_gotv_voted
...
matched_turnout <- matchit(GOTV_call ~ voted1996 + AGE + MAJORPTY, 
                           data = turnout, method = "nearest", 
                           ratio = 5)

matched_turnout_set <- match.data(matched_turnout)

summary(matched_turnout)
